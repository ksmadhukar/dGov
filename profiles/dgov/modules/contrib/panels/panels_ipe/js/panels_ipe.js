...
(function ($, _, Backbone, Drupal, drupalSettings) {
  ...
  Drupal.panels_ipe.init = function (settings) {
    ...
    if (settings.panels_ipe.user_permission.change_layout) {
      tab_collection.add(createTabModel(Drupal.t('Layouts'), 'change_layout'));
    }
  //  tab_collection.add(createTabModel(Drupal.t('Blocks'), 'add_objects'));
    tab_collection.add(createTabModel(Drupal.t('Blocks'), 'manage_content'));
    ...
    tab_views.add_objects = new Drupal.panels_ipe.BlockPicker();
