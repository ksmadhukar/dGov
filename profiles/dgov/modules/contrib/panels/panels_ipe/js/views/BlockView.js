...
(function ($, _, Backbone, Drupal) {
  ...
  Drupal.panels_ipe.BlockView = Backbone.View.extend(/** @lends Drupal.panels_ipe.BlockView# */{
    ...
    template_actions: _.template(
      ...
      '     </li>' +
      '     <li class="pane-ipe-change-style">' + Drupal.t('<a class="use-ajax" data-dialog-type="modal" href="/admin/config/style/<%- plugin_id %>/<%- label %>/<%- id %>?width=500&height=500&iframe=true"><i class="fa fa-sliders" aria-hidden="true"></i></a>') + '</li>' +
      '    <% } %>' +
